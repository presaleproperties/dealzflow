  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select('user_id, slug, display_name, email, headshot_url, brokerage, license_no, timezone, bio, scheduler_onboarded_at, default_buffer_min, default_min_notice_min')
