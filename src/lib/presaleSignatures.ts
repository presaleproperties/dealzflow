...
export type PresaleSignaturePresetId = "presale_card" | "presale_lofty";
...
export const PRESALE_SIGNATURE_PRESETS: Array<{
  ...
  {
    id: "presale_card",
    label: "Presale Card (rich)",
    description:
      "Full agent card with headshot, contact info, and the Presale Properties brand logo. Best for Gmail / Outlook 1:1 and campaign sends.",
