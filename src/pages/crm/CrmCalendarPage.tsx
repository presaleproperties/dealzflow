...
export default function CrmCalendarPage() {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 crm-mobile-page">
      ...
      <div className="sticky top-0 z-20 -mx-3 px-3 sm:mx-0 sm:px-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/70 pt-2 pb-2 sm:static sm:bg-transparent sm:backdrop-blur-0 sm:pb-0 sm:pt-0">
        {/* Row 1: Title + add */}
