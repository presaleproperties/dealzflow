...
const ALL_COLUMNS: ColumnDef[] = [
  ...
  { key: 'assigned_to', sortKey: 'assigned_to', label: 'Agent', width: '120px' },
  ...
  return (
    <div onClick={e => e.stopPropagation()}>
      <Select value={activeSeg?.id ?? ''} onValueChange={onPick}>
        <SelectTrigger
          className="h-auto leading-none border-0 px-2 py-0.5 text-[10.5px] font-medium shadow-none hover:opacity-90 rounded-full w-auto min-w-0 gap-0 [&>svg:last-child]:hidden focus:ring-1 focus:ring-offset-0"
