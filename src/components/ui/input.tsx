  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-xl border border-border/60 bg-muted/30 px-4 py-2.5 text-base ring-offset-background transition-all duration-200",
          ...
          "md:text-sm tracking-[-0.01em] font-medium",
          className
        )}
        ref={ref}
        {...props}
